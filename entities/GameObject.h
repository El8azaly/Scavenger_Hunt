...
public:
    ...
    // Clean up the dynamically allocated sprite
...
protected:
    ...
    float m_spriteOffsetX = 0; // Relative to hitbox top-left
    float m_spriteOffsetY = 0; 
    float m_spriteWidth = 0;   // Visual width
    float m_spriteHeight = 0;  // Visual height
